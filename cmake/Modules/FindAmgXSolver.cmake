...
if(${CUDA_FOUND})
    SET(CUDA_LIBRARY_DIRS "-L${CUDA_TOOLKIT_ROOT_DIR}/lib64/ ${CUDA_LIBRARIES}")
...
set(AMGXSOLVER_LIBRARIES ${AMGXSOLVER_LIBRARIES} ${CUDA_LIBRARY_DIRS} -lcublas -lcusparse -lcusolver)
